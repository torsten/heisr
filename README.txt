...
Additionally some news items between heise online and heise security are duplicated so reading both feeds results in reduntant content.
...
as a command line app which you can integrate as screipt feed into NetNewsWire
for example.
